...
export const DATA = {
  ...
  work: [
    ...
    {
      company: "Ubiquiti",
      href: "https://www.ui.com.cn/jp/zh/wifi/enterprise",
      badges: [],
      location: "中国",
      title: "服务器开发工程师",
      logoUrl: withBasePath("/logo-ubiquiti.png"),
      start: "2022.01",
      end: "2024.06",
      description:
        "参与企业级网络与 WiFi 管理平台相关服务端研发，围绕设备接入、配置管理、数据同步、状态监控与业务接口等场景承担后端模块设计与开发，并参与系统稳定性、数据处理链路和接口性能优化。",
    },
  ],
  education: [
    {
  ...
  projects: [
    ...
    {
      title: "去中心化点对点电子现金系统（比特币协议兼容，Golang 适配）",
      href: "https://github.com/yongfufuufu-ops/bitcoin_java",
      dates: "2025.12 - 2026.05",
      description:
        "基于 Java 21 + Spring Boot 构建去中心化点对点电子现金系统，围绕比特币协议兼容的区块、交易、UTXO、TxPool、RBF 替换、挖矿与链同步等核心能力实现基础链路。设计 RocksDB 本地存储、地址/交易索引、区块浏览接口和静态监控页面，并实现基于 QUIC/P2P 的节点连接、DHT 路由、广播、黑名单、流控与拥塞控制等网络模块。",
      technologies: [
        "Java 21",
        "Spring Boot",
        "bitcoinj",
