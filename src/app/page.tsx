    ...
    <main className="min-h-dvh flex flex-col gap-14 relative">
      <section id="hero">
        <div className="mx-auto w-full max-w-2xl space-y-8">
          <div className="gap-2 gap-y-6 flex flex-col md:flex-row justify-between md:min-h-[140px]">
            <div className="gap-2 flex flex-col order-2 md:order-1">
              ...
              />
              <BlurFadeText
                className="text-muted-foreground max-w-[520px] text-lg leading-relaxed md:text-xl"
                delay={BLUR_FADE_DELAY}
